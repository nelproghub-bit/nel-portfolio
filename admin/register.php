...
<head>
    ...
    <title>Admin Registration - Nel Portfolio</title>
    <!-- Tailwind CSS -->
...
<body class="bg-slate-950 text-slate-100 min-h-screen flex flex-col items-center justify-center relative overflow-x-hidden overflow-y-auto bg-grid-pattern selection:bg-cyan-500/30 selection:text-cyan-200 py-10 px-4">
    ...
    <div class="fixed inset-0 overflow-hidden -z-10 pointer-events-none">
        <div class="absolute -top-[25%] -right-[15%] w-[60%] h-[60%] rounded-full bg-cyan-500/15 blur-[140px] animate-pulse"></div>
        <div class="absolute -bottom-[20%] -left-[15%] w-[55%] h-[55%] rounded-full bg-indigo-600/20 blur-[130px]"></div>
        <div class="absolute top-[30%] left-[50%] -translate-x-1/2 w-[35%] h-[35%] rounded-full bg-teal-400/10 blur-[120px]"></div>
    </div>
    ...
    <div class="w-full max-w-md p-6 sm:p-10 my-auto rounded-3xl luxe-glass-card relative z-10 transition-all duration-300">
        ...
        <div class="flex justify-center mb-6">
            <div class="w-14 h-14 rounded-2xl bg-gradient-to-tr from-cyan-500 to-indigo-600 p-[1px] shadow-lg shadow-cyan-500/20">
                <div class="w-full h-full bg-slate-950 rounded-[15px] flex items-center justify-center">
                    <i class="ph-bold ph-user-plus text-2xl text-cyan-400"></i>
                </div>
            </div>
        </div>
        ...
        <!-- Registration Form -->
        <form hx-post="/nel-portfolio/api/register_handler.php" hx-target="#auth-message" hx-indicator="#loading-spinner" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    ...
                    <input type="text" id="username" name="username" required minlength="3" maxlength="50" placeholder="Choose a username"
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    ...
                    <button type="button" onclick="togglePasswordVisibility('password', 'password-toggle-icon')" class="absolute right-4 text-slate-400 hover:text-cyan-400 transition-colors focus:outline-none" title="Toggle password visibility">
            ...
            <div>
                <!-- Montserrat Semi Bold Typography: Subhead for field label -->
                <label for="confirm_password" class="block font-subhead text-xs font-semibold uppercase text-slate-300 tracking-wider mb-2">
                    Confirm Password
                </label>
                <div class="relative flex items-center">
                    <span class="absolute left-4 text-slate-400">
                    ...
                    <input type="password" id="confirm_password" name="confirm_password" required minlength="6" placeholder="••••••••"
                        class="w-full font-body luxe-input rounded-xl pl-11 pr-11 py-3 text-sm text-white placeholder-slate-500 transition-all">
                    <button type="button" onclick="togglePasswordVisibility('confirm_password', 'confirm-password-toggle-icon')" class="absolute right-4 text-slate-400 hover:text-cyan-400 transition-colors focus:outline-none" title="Toggle password visibility">
                        <i id="confirm-password-toggle-icon" class="ph-bold ph-eye text-lg"></i>
                    </button>
                </div>
            </div>
            ...
            <div class="pt-2 text-center">
                <p class="font-body text-xs text-slate-400">
                    ...
                    <a href="/nel-portfolio/admin/login.php" class="font-subhead font-semibold text-cyan-400 hover:text-cyan-300 transition-colors underline underline-offset-4 decoration-cyan-500/30 hover:decoration-cyan-400">
                        Sign In
                    </a>
                </p>
            </div>
